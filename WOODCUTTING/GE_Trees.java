...
@ScriptManifest(name="GE Chopper", info="Chops Trees South GE", author="Acinate", version=1.0, logo="")
public class GE_Trees extends Script {

    Area AREA_TREES = new Area(3145, 3465, 3172, 3450);
    Area AREA_BANK = new Area(3187, 3444, 3180, 3447);
    ...
    public int onLoop() throws InterruptedException {
        ...
        switch(getState()) {
            ...
            case CHOP:
                tree = objects.closest(AREA_TREES, "Tree");
